Rails.application.configure do
  ...
  # config.active_job.queue_name_prefix = "a-index_#{Rails.env}"
  ...
  config.action_mailer.default_url_options = { :host => 'http://http://153.127.39.117/' }
